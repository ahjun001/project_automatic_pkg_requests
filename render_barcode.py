...
if __name__ == '__main__':
    Barcode().run()
    # Barcode(text='Ean13', height='20',
    #         barcode='355555666666').run(args = ['--output', 'drawing_o.svg', 'drawing.svg'])
    # Barcode(barcode='312345678901').run(args = ['--output', 'drawing_o.svg', 'drawing.svg'])
